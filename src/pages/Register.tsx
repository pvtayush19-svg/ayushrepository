          ...
          <form className="space-y-6" onSubmit={handleRegister}>
            ...
            <div>
              ...
              <select value={role} onChange={(e) => setRole(e.target.value as any)}
                className="mt-1 block w-full pl-3 pr-10 py-3 bg-white/50 text-base border-slate-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent sm:text-sm rounded-xl transition-all hover:bg-white">
